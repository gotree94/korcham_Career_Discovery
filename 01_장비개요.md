...
| 이미지 | 설명 |
| :---: | :--- |
| ![](img/re_004.png) | ① **LiDAR** : SLAM을 이용하여 로봇의 주행환경을 SCAN 및 분석한다.<br><br>② **움직임 감지 센서** : 움직임을 감지하여 그 값을 로봇에 전달해 준다. |

<img src="img/re_004.png" width="200">

### 로봇 세부 구조 (상단)

<img src="img/re_005.png" width="50%">

### 로봇 세부 구조 (후면)

<img src="img/re_003.png" width="50%">

### 로봇 세부 구조 (측면)

<img src="img/re_002.png" width="50%">
